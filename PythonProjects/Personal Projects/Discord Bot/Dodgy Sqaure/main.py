...
class DodgySquare:
    def __init__(self):
        logger.info("Initializing DodgySquare game...")
        # Pygame
        pygame.init()
    ...
    def create_enemy(self):
        ...
        logger.debug("Creating new enemy...")
    ...
    def update_enemy_positions(self):
        ...
        logger.debug("Updating enemy positions...")
            ...
            if -self.enemy_size <= enemy_pos[1] < self.screen_height:
                ...
                if self.enemy_frequency > 10:
                    if self.score % 15 == 0:
                        ...
                        logger.info("Difficulty increased. Enemy frequency: %d", self.enemy_frequency)
    ...
    def detect_collision(self, player_pos: list[int], enemy_pos: list[int]) -> bool:
        ...
        logger.debug("Detecting collision...")
        px, py = player_pos
        ex, ey = enemy_pos
    ...
    def show_game_over(self):
        ...
        logger.info("Game over. Displaying game-over text...")
        # Create the text
    ...
    def draw_character(self, color: tuple, position: list[int], size: int):
        ...
        logger.debug("Drawing character...")
    ...
    def start_screen(self):
        ...
        while not self.game_started:
            ...
            coordinates: tuple = (self.screen_width // 2 - text_width // 2, self.screen_height // 2 - text_height // 2)
            self.screen.blit(start_text, coordinates)
    ...
    def run(self):
        ...
        while True:
            ...
            if not self.game_over and self.game_started:
                ...
                self.show_game_over()
                self.game_started = False  # Reset game_started flag
            ...
            # Suppress INFO messages during game over screen
